...
(function(){
  const DASH_COST=3;
  const DASH_GROUND_RATIO=.07;
  const DASH_BASE_SPEED=.48;
  window.DUCKIE_DASH_CORE='24.227-lower-faster-foreground';

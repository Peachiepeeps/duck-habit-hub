(function(){
  ...
  const SCENES = {
    ...
    hibiki: {
      ...
      reward() {
        ...
        save(data);
        window.dispatchEvent(new CustomEvent("duckie-love-interest-unlocked", { detail: { id: "hibiki" } }));
      }
    },
    devlin: {
      id: "devlin",
      ...
      reward() {
        ...
        save(data);
        window.dispatchEvent(new CustomEvent("duckie-love-interest-unlocked", { detail: { id: "devlin" } }));
      }
    },
    "shinobu-cheryln": {
      id: "shinobu-cheryln",
    ...
    "devlin-hibiki": {
      ...
      reward() {
        ...
        save(data);
        window.dispatchEvent(new CustomEvent("duckie-love-interest-unlocked", { detail: { id: "devlin-hibiki" } }));
      }
    }
  };
  ...
  function ensureAll(data){
    ...
    for (const key of ["lukio", "shinobu", "cheryln", "hibiki", "devlin"]) {

...
const IO_CLOSET = [
  ...
  { id: "extras", label: "Extras", type: "multi", options: ["ahoge", "heart-pin", "sheep-ears", "crown", "mew-garter", "mew-jacket", "mew-collar", "daisy-crown", "ocean-sunglasses", "halo"] }
];
...
const MIHO_CLOSET = [
  ...
  { id: "extras", label: "Extras", type: "multi", options: ["belt", "neck-bow", "daisy-crown", "ocean-sunglasses", "halo"] }
];
...
const MIKO_CLOSET = [
  ...
  { id: "shoes", label: "Shoes", type: "single", allowNone: true, options: ["shoes-loafer", "shoes-fancy-loafers"] },
  {
    ...
    label: "Extras",
    type: "multi",
    options: ["headband", "hairpins-black", "daisy-crown", "ocean-sunglasses", "halo"]
  }
];
...
const CLOSET = [
  ...
  { id: "tail", label: "Tails", type: "single", allowNone: true, options: ["tail-cow", "tail-bunny"] },
  {
    ...
    label: "Extras",
    type: "multi",
    options: ["jacket", "cardigan-white", "collar", "leg-bandage", "horns", "cheek-bandage", "left-bow", "right-bow", "bow-white", "hair-side-ribbon", "large-back-bow", "beret", "daisy-crown", "ocean-sunglasses", "halo"]
  }
...
function normalizeMihoOutfit(rawOutfit = {}) {
  ...
  normalized.extras = Array.isArray(normalized.extras)
    ? normalized.extras.filter(id => ["belt", "neck-bow", "daisy-crown", "ocean-sunglasses", "halo"].includes(id))
...
function normalizeIoOutfit(rawOutfit = {}) {
  ...
  normalized.extras = Array.isArray(normalized.extras)
    ? normalized.extras.filter(id => ["ahoge", "heart-pin", "sheep-ears", "crown", "mew-garter", "mew-jacket", "mew-collar", "daisy-crown", "ocean-sunglasses", "halo"].includes(id))
    : ["heart-pin"];
  return normalized;
}
...
function closetLockedMessage(id, asset) {
  const questRewardHints = {
    ...
    "ocean-sunglasses": "Sunglasses are locked — complete Ocean Rank 100 in Duck Quest!",
    "halo": "Halo is locked — complete Cloud Garden Rank 150 in Duck Quest!"
  };

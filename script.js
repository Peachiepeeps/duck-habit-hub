...
const DEFAULT_SAVE = {
  ...
  unlockedRooms: ["cream"],
  unlockedItems: ["hair-short", "cat-ears", "left-bow", "right-bow", "top-sweater", "bottom-pleated", "sock-left-rainbow", "sock-right-rainbow", "shoes-loafer", "collar", "cheek-bandage"],
...
function buyShopItem() {
  ...
  if (!isRepeatBuyShopListing(listing)) {
    ...
    showToast(`Bought ${item.name}! It has been cleared from Supplies. ♡`);
    return;
  }

...
const DEFAULT_SAVE = {
  ...
  unlockedRooms: ["cream"],
  unlockedItems: ["hair-short", "cat-ears", "left-bow", "right-bow", "top-sweater", "bottom-pleated", "sock-left-rainbow", "sock-right-rainbow", "shoes-loafer"],
  peepPokes: 0,
  tinyDuckSightings: 0,
...
const PEEP_STARTER_WARDROBE = Object.freeze([
  "hair-short", "cat-ears", "left-bow", "right-bow", "top-sweater", "bottom-pleated", "sock-left-rainbow", "sock-right-rainbow", "shoes-loafer"
]);

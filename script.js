...
const SHOP_CATEGORIES = {
  ...
  profiles: {
    label: "OC Invitations",
    subtitle: "Invite new OCs to the hub and unlock their wardrobe pages."
  },
  rooms: {
    label: "Room Styles",
    subtitle: "Unlock a new room color permanently for 90 Pink Coins."
  },
  furniture: {
    label: "Furniture",
...
const SHOP_STOCK = {
  supplies: [
    { itemId: "standard-duck", price: 50 },
    { itemId: "sunglasses", price: 30 },
    { itemId: "yarn", price: 30 },
    { itemId: "thread", price: 30 },
    { itemId: "party-hat", price: 30 },
    { itemId: "knife", price: 35 },
    { itemId: "game-controller", price: 35 },
    { itemId: "pill", price: 30 },
    { itemId: "ufo", price: 40 },
    { itemId: "pocket-monster-ball", price: 40 },
    { itemId: "jester-bell", price: 35 },
    { itemId: "crown", price: 40 },
    { itemId: "magical-girl-pendant", price: 40 },
    { itemId: "bunny-ears", price: 35 },
    { itemId: "flower", price: 28 },
    { itemId: "sleep-mask", price: 30 },
    { itemId: "paintbrush", price: 30 },
    { itemId: "ghost", price: 35 },
    { itemId: "demon-wing", price: 40 },
    { itemId: "angel-wing", price: 40 },
    { itemId: "glitter", price: 35 },
    { itemId: "cat-ears", price: 35 },
    { itemId: "moon", price: 35 },
    { itemId: "mustache", price: 30 },
    { itemId: "top-hat", price: 35 },
    { itemId: "bow", price: 30 }
  ],
  paint: [
    { itemId: "red-paint", price: 35 },
    { itemId: "orange-paint", price: 35 },
    { itemId: "gold-paint", price: 35 },
    { itemId: "silver-paint", price: 35 },
    { itemId: "bronze-paint", price: 35 },
    { itemId: "green-paint", price: 35 },
    { itemId: "blue-paint", price: 35 },
    { itemId: "purple-paint", price: 35 },
    { itemId: "white-paint", price: 35 },
    { itemId: "black-paint", price: 35 }
  ],
  profiles: [
    { characterId: "miko", price: 120 }
  ],
  rooms: [
    { roomId: "green", price: 90 },
    { roomId: "blue", price: 90 },
    { roomId: "purple", price: 90 },
    { roomId: "peach", price: 90 },
    { roomId: "pink", price: 90 },
    { roomId: "dark-purple", price: 90 },
    { roomId: "cotton-candy", price: 90 },
    { roomId: "chocolate-brown", price: 90 }
  ],
  furniture: [
    { itemId: "petbed-gray", price: 55 },
    { itemId: "petbed-pink", price: 55 },
    { itemId: "petbed-cream", price: 55 },
    { itemId: "petbed-red", price: 55 },
    { itemId: "petbed-blue", price: 55 },
    { itemId: "shelf-white", price: 65 },
    { itemId: "shelf-dark-brown", price: 65 },
    { itemId: "shelf-brown", price: 65 },
    { itemId: "dresser-brown", price: 65 },
    { itemId: "dresser-dark-brown", price: 65 },
    { itemId: "rug-cloud-dark", price: 50 },
    { itemId: "rug-cloud-white", price: 50 },
    { itemId: "rug-heart-white", price: 50 },
    { itemId: "rug-heart-dark", price: 50 },
    { itemId: "rug-heart-pink", price: 50 },
    { itemId: "rug-heart-blue", price: 50 }
  ],
  hair: [
    { wardrobeId: "hair-low-pigtails", price: 70 },
    { wardrobeId: "hair-ponytail", price: 70 },
    { wardrobeId: "hair-long-pigtails", price: 70 },
    { wardrobeId: "hair-jellyfish", price: 70 }
  ],
  clothing: [
    { wardrobeId: "top-shirt", price: 70 },
    { wardrobeId: "bottom-fluffy", price: 70 },
    { wardrobeId: "socks-blue", price: 70 },
    { wardrobeId: "jacket", price: 70 },
    { wardrobeId: "miko-top-sweater", price: 75 },
    { wardrobeId: "miko-bottom-jeans", price: 75 }
  ],
  shoes: [
    { wardrobeId: "shoes-sneaker", price: 70 }
  ],
  accessories: [
    { wardrobeId: "cow-ears", price: 70 },
    { wardrobeId: "tail-cow", price: 70 },
    { wardrobeId: "collar", price: 70 },
    { wardrobeId: "leg-bandage", price: 70 },
    { wardrobeId: "horns", price: 70 },
    { wardrobeId: "hair-side-ribbon", price: 70 },
    { wardrobeId: "large-back-bow", price: 70 },
    { wardrobeId: "beret", price: 70 },
    { wardrobeId: "miko-headband", price: 70 }
  ]
};
...
const MIKO_ASSETS = {
  ...
  "arm-base": { label: "Arm Base", file: "Miko-base-arm.PNG", z: 34 },
  ...
  "top-hoodie": { label: "Hoodie", file: "Miko-hoodie.PNG", previewFile: "Miko-hoodie-closet.PNG", z: 32 },
  "top-hoodie-sleeve": { label: "Hoodie Sleeve", file: "Miko-hoodie-sleeve.PNG", z: 36 },
  "hoodie-back": { label: "Hoodie Back", file: "Miko-hoodie-back.PNG", z: 18 },
  "top-sweater": { label: "Sweater", file: "Miko-sweater.PNG", previewFile: "Miko-sweater-closet.PNG", z: 32 },
  ...
  "headband": { label: "Headband", file: "Miko-headband.PNG", z: 52 },
...
const MIKO_CLOSET = [
  ...
  { id: "top", label: "Tops", type: "single", options: ["top-hoodie", "top-button", "top-sweater"] },
...
const MAX_CHARACTER_HAPPINESS = 100;
    ...
    const merged = {
      ...
      characterOutfits: {
        ...
        miko: {
          ...
          ...(saved.characterOutfits?.miko || {})
        }
      },
      characterProgress: {
        peep: {
          happiness: Math.max(0, Math.min(MAX_CHARACTER_HAPPINESS,
            Number(saved.characterProgress?.peep?.happiness)
              || Number(saved.stats?.happiness)
              || 0))
        },
        miko: {
          happiness: Math.max(0, Math.min(MAX_CHARACTER_HAPPINESS,
            Number(saved.characterProgress?.miko?.happiness) || 0))
        }
      },
...
function clampCharacterHappiness(value) {
  return Math.max(0, Math.min(MAX_CHARACTER_HAPPINESS, Number(value) || 0));
}
...
function normalizeCharacterState() {
  ...
  save.characterProgress.peep = {
    happiness: clampCharacterHappiness(
      save.characterProgress.peep?.happiness ?? save.stats?.happiness ?? 0
    )
  };
  save.characterProgress.miko = {
    happiness: clampCharacterHappiness(save.characterProgress.miko?.happiness ?? 0)
  };
...
function getCharacterProgress(characterId = save.selectedCharacter) {
  ...
  if (!save.characterProgress[characterId]) {
    save.characterProgress[characterId] = { happiness: 0 };
  }
  save.characterProgress[characterId].happiness = clampCharacterHappiness(save.characterProgress[characterId].happiness);
...
function addCharacterHappiness(amount, characterId = save.selectedCharacter) {
  ...
  const before = progress.happiness;
  progress.happiness = clampCharacterHappiness(before + Number(amount || 0));
  return progress.happiness - before;
}
...
function getMikoEquippedAssetIds() {
  ...
  if (outfit.top === "top-hoodie") ids.push("hoodie-back");
  if (outfit.bottom) ids.push(outfit.bottom);
  if (outfit.top) ids.push(outfit.top);

  ids.push("arm-base");
  if (outfit.top === "top-button") ids.push("top-button-sleeve");
  else if (outfit.top === "top-hoodie") ids.push("top-hoodie-sleeve");
  else if (outfit.top === "top-sweater") ids.push("top-sweater-sleeve");
...
function renderRoomPicker() {
  ...
  for (const room of ROOMS) {
    ...
    button.addEventListener("click", () => {
      if (!unlocked) {
        showToast("Locked — unlock this room from the Shop for 90 Pink Coins!");
        return;
      }
      if (currentRoomView === "wing" && save.roomExpansion?.unlocked) {
...
function renderHairOptions(group) {
  ...
  for (const id of group.options) {
    ...
    closetOptions.append(makeOptionCard({
      ...
      onClick: () => {
        if (!unlocked) {
          showToast(`${asset.label} is locked — unlock it from Shop → Hair for 70 Pink Coins!`);
          return;
        }
        outfit.hair = id;
        persist();
...
function getTotalUnlockedCharacterHappiness() {
  return (save.unlockedCharacters || [])
    .map(characterId => getCharacterProgress(characterId).happiness)
...
function renderStatus() {
  ...
  const happiness = getCharacterProgress(save.selectedCharacter).happiness;
  const percent = (happiness / MAX_CHARACTER_HAPPINESS) * 100;

  statusLevelBadge.textContent = `Happiness Lv. ${happiness}`;
  statusHappinessLabel.textContent = `${happiness} / ${MAX_CHARACTER_HAPPINESS} ♡`;
  statusXpText.textContent = `${happiness} / ${MAX_CHARACTER_HAPPINESS}`;
  statusXpFill.style.width = `${percent}%`;
  ...
  statusHappiness.textContent = `${happiness} / ${MAX_CHARACTER_HAPPINESS}`;
...
if (achievementsUnlockedOnLoad.length) {
  setTimeout(() => {

...
function renderSockStyle(style) {
  ...
  visual.className = "sock-style-visual";
  visual.append(makeCombinedThumb([style.left, style.right]));
  ...
  controls.className = "sock-style-controls";

  const header = document.createElement("div");
  header.className = "sock-placement-header";
  const placementLabel = document.createElement("span");
  placementLabel.textContent = "Placement";
  header.append(placementLabel);

  const clear = document.createElement("button");
  clear.type = "button";
  clear.className = "sock-clear-button";
  clear.textContent = "×";
  clear.setAttribute("aria-label", `Remove ${style.label} socks`);
  const styleIsUsed = save.outfit.leftSock === style.left || save.outfit.rightSock === style.right;
  clear.disabled = !styleIsUsed;
  ...
  buttons.className = "sock-placement-buttons";
  ...
  buttons.append(makeSockPlacementButton("L", leftSelected, () => {
  ...
  buttons.append(makeSockPlacementButton("R", rightSelected, () => {
  ...
  buttons.append(makeSockPlacementButton("LR", bothSelected, () => {
    save.outfit.leftSock = style.left;
    save.outfit.rightSock = style.right;
    persist();
    renderPeep();
...
function renderSockOptions() {
  ...
  helper.textContent = "Choose left, right, or both. You can mix styles too!";

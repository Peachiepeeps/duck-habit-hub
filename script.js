...
function getMikoEquippedAssetIds() {
  ...
  // Miko's default hoodie outfit is layered over his free button-down shirt.
  // The shirt body/sleeve return automatically whenever the Hoodie is equipped.
  if (outfit.top === "top-hoodie") ids.push("hoodie-back");
  if (outfit.bottom) ids.push(outfit.bottom);

  if (outfit.top === "top-hoodie") {
    ids.push("top-button", "top-hoodie");
  } else if (outfit.top) {
    ids.push(outfit.top);
  }

  ids.push("arm-base");
  if (outfit.top === "top-button") {
    ids.push("top-button-sleeve");
  } else if (outfit.top === "top-hoodie") {
    ids.push("top-button-sleeve", "top-hoodie-sleeve");
  } else if (outfit.top === "top-sweater") {
    ids.push("top-sweater-sleeve");
  }

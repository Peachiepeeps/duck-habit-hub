const APP_CACHE = 'duck-habit-hub-app-v24-148';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-148';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-148','./version.json',
  './style-v24-148.css','./script-v24-148.js','./sw-v24-148.js','./sw.js',

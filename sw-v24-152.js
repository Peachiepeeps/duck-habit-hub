const APP_CACHE = 'duck-habit-hub-app-v24-152';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-152';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-152','./version.json',
  './style-v24-152.css','./script-v24-152.js','./sw-v24-152.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v69.js','./duck-quest/css/style-v61.css',
  './bakery/index.html'
];

const APP_CACHE = 'duck-habit-hub-app-v24-157';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-157';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-157','./version.json',
  './style-v24-157.css','./script-v24-157.js','./sw-v24-157.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v74.js?v=24-157','./duck-quest/css/style-v66.css?v=24-157',
  './bakery/index.html'
];

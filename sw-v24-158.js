const APP_CACHE = 'duck-habit-hub-app-v24-158';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-158';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-158','./version.json',
  './style-v24-158.css','./script-v24-158.js','./sw-v24-158.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v75.js?v=24-158','./duck-quest/css/style-v67.css?v=24-158',
  './bakery/index.html'
];

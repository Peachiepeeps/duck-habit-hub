const APP_CACHE = 'duck-habit-hub-app-v24-159';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-159';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-159','./version.json',
  './style-v24-159.css','./script-v24-159.js','./sw-v24-159.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v76.js?v=24-159','./duck-quest/css/style-v68.css?v=24-159',
  './bakery/index.html'
];

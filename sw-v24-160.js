const APP_CACHE = 'duck-habit-hub-app-v24-160';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-160';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-160','./version.json',
  './style-v24-160.css','./script-v24-160.js','./sw-v24-160.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v77.js?v=24-160','./duck-quest/css/style-v69.css?v=24-160',
  './bakery/index.html'
];

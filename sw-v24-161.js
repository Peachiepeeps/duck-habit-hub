const APP_CACHE = 'duck-habit-hub-app-v24-161';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-161';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-161','./version.json',
  './style-v24-161.css','./script-v24-161.js','./sw-v24-161.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v78.js?v=24-161','./duck-quest/css/style-v70.css?v=24-161',
  './bakery/index.html'
];

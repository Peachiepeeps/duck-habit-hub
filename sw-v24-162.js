const APP_CACHE = 'duck-habit-hub-app-v24-162';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-162';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-162','./version.json',
  './style-v24-162.css','./script-v24-162.js','./sw-v24-162.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v79.js?v=24-162','./duck-quest/css/style-v71.css?v=24-162',
  './bakery/index.html'
];

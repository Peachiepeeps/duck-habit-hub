const APP_CACHE = 'duck-habit-hub-app-v24-163';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-163';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-163','./version.json',
  './style-v24-163.css','./script-v24-163.js','./sw-v24-163.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v80.js?v=24-163','./duck-quest/css/style-v72.css?v=24-163',
  './bakery/index.html'
];

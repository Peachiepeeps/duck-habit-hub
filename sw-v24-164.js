const APP_CACHE = 'duck-habit-hub-app-v24-164';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-164';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-164','./version.json',
  './style-v24-164.css','./script-v24-164.js','./sw-v24-164.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v81.js?v=24-164','./duck-quest/css/style-v73.css?v=24-164',
  './bakery/index.html'
];

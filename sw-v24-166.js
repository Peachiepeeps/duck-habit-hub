const APP_CACHE = 'duck-habit-hub-app-v24-166';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-166';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-166','./version.json',
  './style-v24-166.css','./script-v24-166.js','./sw-v24-166.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v82.js?v=24-166','./duck-quest/css/style-v73.css?v=24-166',
  './bakery/index.html'
];

const APP_CACHE = 'duck-habit-hub-app-v24-167';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-167';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-167','./version.json',
  './style-v24-167.css','./script-v24-167.js','./sw-v24-167.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v83.js?v=24-167','./duck-quest/css/style-v73.css?v=24-167',
  './bakery/index.html'
];

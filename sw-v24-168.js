const APP_CACHE = 'duck-habit-hub-app-v24-168';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-168';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-168','./version.json',
  './style-v24-168.css','./script-v24-168.js','./sw-v24-168.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v84.js?v=24-168','./duck-quest/css/style-v73.css?v=24-168',
  './bakery/index.html'
];

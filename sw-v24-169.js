const APP_CACHE = 'duck-habit-hub-app-v24-169';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-169';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-169','./version.json',
  './style-v24-169.css','./script-v24-169.js','./sw-v24-169.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v85.js?v=24-169','./duck-quest/css/style-v73.css?v=24-169',
  './bakery/index.html'
];

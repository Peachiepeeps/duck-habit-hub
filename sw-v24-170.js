const APP_CACHE = 'duck-habit-hub-app-v24-170';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-170';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-170','./version.json',
  './style-v24-170.css','./script-v24-170.js','./sw-v24-170.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v86.js?v=24-170','./duck-quest/css/style-v73.css?v=24-170',
  './bakery/index.html'
];

const APP_CACHE = 'duck-habit-hub-app-v24-171';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-171';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-171','./version.json',
  './style-v24-171.css','./script-v24-171.js','./sw-v24-171.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v86.js?v=24-171','./duck-quest/css/style-v74.css?v=24-171',
  './bakery/index.html'
];

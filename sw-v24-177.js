const APP_CACHE = 'duck-habit-hub-app-v24-177';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-177';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-177','./version.json',
  './style-v24-177.css','./script-v24-177.js','./sw-v24-177.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v92.js?v=24-177','./duck-quest/css/style-v80.css?v=24-177',
  './bakery/index.html'
];

const APP_CACHE = 'duck-habit-hub-app-v24-180';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-180';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-180','./version.json',
  './style-v24-180.css','./script-v24-180.js','./sw-v24-180.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v94.js?v=24-180','./duck-quest/js/hatchery-v179.js?v=24-180','./duck-quest/js/dash-home-v180.js?v=24-180','./duck-quest/css/style-v82.css?v=24-180',
  './bakery/index.html'
];

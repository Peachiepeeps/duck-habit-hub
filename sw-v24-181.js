const APP_CACHE = 'duck-habit-hub-app-v24-181';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-181';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-181','./version.json',
  './style-v24-181.css','./script-v24-181.js','./sw-v24-181.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v94.js?v=24-181','./duck-quest/js/hatchery-v179.js?v=24-181','./duck-quest/js/dash-home-v180.js?v=24-181','./duck-quest/js/dash-screen-v181.js?v=24-181','./duck-quest/css/style-v82.css?v=24-181',
  './bakery/index.html'
];

const APP_CACHE = 'duck-habit-hub-app-v24-182';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-182';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-182','./version.json',
  './style-v24-182.css','./script-v24-182.js','./sw-v24-182.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v94.js?v=24-182','./duck-quest/js/hatchery-v179.js?v=24-182','./duck-quest/js/dash-home-v180.js?v=24-182','./duck-quest/js/dash-screen-v182.js?v=24-182','./duck-quest/css/style-v82.css?v=24-182',
  './bakery/index.html'
];

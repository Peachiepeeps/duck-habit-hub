const APP_CACHE = 'duck-habit-hub-app-v24-186';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-186';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-186','./version.json',
  './style-v24-186.css','./script-v24-186.js','./sw-v24-186.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v95.js?v=24-186','./duck-quest/js/hatchery-v179.js?v=24-186','./duck-quest/js/hatchery-egg-position-v186.js?v=24-186','./duck-quest/js/dash-home-v180.js?v=24-186','./duck-quest/js/dash-screen-v184.js?v=24-186','./duck-quest/css/style-v82.css?v=24-186',
  './bakery/index.html'
];

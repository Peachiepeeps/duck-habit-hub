const APP_CACHE = 'duck-habit-hub-app-v24-190';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-190';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-190','./version.json',
  './style-v24-190.css','./script-v24-190.js','./sw-v24-190.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v95.js?v=24-190','./duck-quest/js/hatchery-v179.js?v=24-190','./duck-quest/js/hatchery-egg-position-v190.js?v=24-190','./duck-quest/js/dash-home-v180.js?v=24-190','./duck-quest/js/dash-screen-v184.js?v=24-190','./duck-quest/css/style-v82.css?v=24-190',
  './bakery/index.html'
];

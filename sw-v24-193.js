const APP_CACHE = 'duck-habit-hub-app-v24-193';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-193';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-193','./version.json',
  './style-v24-193.css','./script-v24-193.js','./sw-v24-193.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v96.js?v=24-193','./duck-quest/js/hatchery-v179.js?v=24-193','./duck-quest/js/hatchery-egg-position-v192.js?v=24-193','./duck-quest/js/hatchery-ui-v193.js?v=24-193','./duck-quest/js/dash-home-v180.js?v=24-193','./duck-quest/js/dash-screen-v184.js?v=24-193','./duck-quest/js/dash-screen-v193.js?v=24-193','./duck-quest/css/style-v82.css?v=24-193',
  './bakery/index.html'
];

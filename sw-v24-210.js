const APP_CACHE = 'duck-habit-hub-app-v24-210';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-210';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-210','./version.json',
  './style-v24-201.css','./script-v24-201.js','./sw-v24-210.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v96.js?v=24-210','./duck-quest/js/quest-fixes-v204.js?v=24-210','./duck-quest/js/quest-fixes-v207.js?v=24-210','./duck-quest/js/quest-fixes-v209.js?v=24-210','./duck-quest/js/hatchery-v179.js?v=24-210','./duck-quest/js/hatchery-egg-position-v192.js?v=24-210','./duck-quest/js/hatchery-ui-v193.js?v=24-210','./duck-quest/js/dash-home-v180.js?v=24-210','./duck-quest/js/dash-screen-v184.js?v=24-210','./duck-quest/js/dash-screen-v193.js?v=24-210','./duck-quest/js/token-shop-v200.js?v=24-210','./duck-quest/css/style-v82.css?v=24-210',
  './bakery/index.html'
];

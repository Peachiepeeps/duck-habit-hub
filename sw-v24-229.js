const APP_CACHE = 'duck-habit-hub-app-v24-229';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-229';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest?v=24-229','./version.json',
  './style-v24-201.css','./script-v24-201.js','./sw-v24-229.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v96.js?v=24-229','./duck-quest/js/quest-fixes-v204.js?v=24-229','./duck-quest/js/quest-fixes-v207.js?v=24-229','./duck-quest/js/quest-fixes-v209.js?v=24-229','./duck-quest/js/theme-refresh-v211.js?v=24-229','./duck-quest/js/theme-fixes-v212.js?v=24-229','./duck-quest/js/boost-items-v213.js?v=24-229','./duck-quest/js/boost-labels-v215.js?v=24-229','./assets/bakery/drops/Gold-heart-refill.webp','./assets/bakery/drops/Pink-heart-refill.webp','./assets/items/quest-boosts/Warm-blanket.png','./assets/items/quest-boosts/Exp-candy-large.png','./assets/items/quest-boosts/Exp-candy-small.png','./hub-shop-boosts-v213.js?v=24-229','./hub-exp-candy-use-v215.js?v=24-229','./duck-quest/js/hatchery-v179.js?v=24-229','./duck-quest/js/hatchery-egg-position-v192.js?v=24-229','./duck-quest/js/hatchery-ui-v193.js?v=24-229','./duck-quest/js/dash-home-v180.js?v=24-229','./duck-quest/js/dash-screen-v184.js?v=24-229','./duck-quest/js/dash-screen-v193.js?v=24-229','./duck-quest/js/token-shop-v200.js?v=24-229','./duck-quest/css/style-v82.css?v=24-229',
  './bakery/index.html',
  './duck-quest/js/dash-background-fix-v226.js?v=24-229',
  './duck-quest/js/merchant-fix-v218.js?v=24-229',

const APP_CACHE = 'duck-habit-hub-app-v24-85';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-85';
const IMAGE_CACHE = 'duck-habit-hub-images-v24-85';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./version.json','./style-v24-85.css','./script-v24-85.js','./sw.js',

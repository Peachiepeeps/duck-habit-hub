const APP_CACHE = 'duck-habit-hub-app-v24-86';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-86';
const IMAGE_CACHE = 'duck-habit-hub-images-v24-86';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./version.json','./style-v24-84.css','./script-v24-85.js','./sw.js',

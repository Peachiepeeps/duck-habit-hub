const APP_CACHE = 'duck-habit-hub-app-v24-95';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-95';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./version.json','./style-v24-85.css','./script-v24-95.js','./sw.js',

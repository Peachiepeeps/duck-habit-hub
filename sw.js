const APP_CACHE = 'duck-habit-hub-app-v24-140';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-140';
...
const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./version.json','./style-v24-140.css','./script-v24-140.js','./sw.js',

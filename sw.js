const APP_CACHE = 'duck-habit-hub-app-v24-143';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-143';
...
const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./version.json','./style-v24-143.css','./script-v24-143.js','./sw.js',

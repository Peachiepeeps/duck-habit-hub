const APP_CACHE = 'duck-habit-hub-app-v24-84';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-84';
const IMAGE_CACHE = 'duck-habit-hub-images-v24-84';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./version.json','./style-v24-84.css','./script-v24-84.js','./sw.js',

const APP_CACHE = 'duck-habit-hub-app-v24-114';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-114';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./version.json','./style-v24-114.css','./script-v24-114.js','./sw.js',

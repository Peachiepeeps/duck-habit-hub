const APP_CACHE = 'duck-habit-hub-app-v24-135';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-135';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

// v24.135: keep the install shell intentionally small. Character art, enemy
...
const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./version.json','./style-v24-135.css','./script-v24-135.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v65.js','./duck-quest/css/style-v57.css',
  './bakery/index.html'
];

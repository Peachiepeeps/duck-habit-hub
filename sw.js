const APP_CACHE = 'duck-habit-hub-app-v24-145';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-145';
...
const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./version.json','./style-v24-145.css','./script-v24-145.js','./sw.js',

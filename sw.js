const APP_CACHE = 'duck-habit-hub-app-v24-128';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-128';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

// v24.128: keep the install shell intentionally small. Character art, enemy
...
const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./version.json','./style-v24-128.css','./script-v24-128.js','./sw.js',
  ...
  './duck-quest/index.html','./duck-quest/js/game-v59.js','./duck-quest/css/style-v51.css',
  './bakery/index.html'
];

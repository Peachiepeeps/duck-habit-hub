const APP_CACHE = 'duck-habit-hub-app-v24-116';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-116';
const IMAGE_CACHE = 'duck-habit-hub-images-stable-v1';

const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./version.json','./style-v24-116.css','./script-v24-116.js','./sw.js',
  ...
  './assets/oc-invitations/Io-invitation.webp','./assets/ducks/io-duck.webp','./assets/oc-invitations/Miho-invitation.webp','./assets/ducks/miho-duck.webp','./duck-quest/index.html','./duck-quest/js/game-v51.js','./duck-quest/css/style-v45.css',

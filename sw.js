const APP_CACHE = 'duck-habit-hub-app-v24-144';
const RUNTIME_CACHE = 'duck-habit-hub-runtime-v24-144';
...
const APP_SHELL = [
  './','./index.html','./manifest.webmanifest','./version.json','./style-v24-144.css','./script-v24-144.js','./sw.js',

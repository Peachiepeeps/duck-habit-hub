(function(){
  ...
  function ensureDustLine(){
    ...
    line.querySelector("#tcDustCountV262").textContent=Number(state.cardDust||0).toLocaleString();
    return line;
  }
  ...
  const detailObserver=new MutationObserver(()=>{
    ensureDustLine();
    const layer=document.querySelector(".tc-detail-layer:not(.hidden)");
    const face=layer?.querySelector("#tcDetailBody > .tc-face[data-card-id]");
  ...
  window.DUCKIE_TRADING_CARD_WORKSHOP_UI="24.262";
})();

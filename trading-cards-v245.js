(function(){
  ...
  function createFace(cardOrId,opts={}){
    ...
    face.append(art,frame,top,bottom,num);if(card.rarity==="rare"){const shine=document.createElement("i");shine.className="tc-shine";face.append(shine);}return face;
  }
